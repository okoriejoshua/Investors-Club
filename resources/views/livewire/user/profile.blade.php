                        ...
                        <div class="card-body">
                            <div class="card card-widget widget-user">
                                ...
                                <div style="top:75px" class="widget-user-image mb-2" wire:click.prevent="openChangePhotoTab({{$ud->id}})">
                                   ...
                                   <div class="row"> 
                                    <span class="theme-bg radius-8 capital mb-3 small-size px-2 mt-1">
                                        <img style="width:20px; padding:0.4px" src="{{ asset('storage/photos/'.auth()->user()->vip_level.'.png')}}" alt="badge" title="{{auth()->user()->vip_level}} member"> {{auth()->user()->vip_level}} Member
                                    </span>
                                </div>
                                </div>
