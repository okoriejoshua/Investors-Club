 <nav style="border-color:#454d5503!important;" class="main-header navbar navbar-expand navbar-dark">
   <!-- Left navbar links -->
   <ul class="navbar-nav">
     <li class="nav-item">
     ...
     <li class="nav-item dropdown">
       <a class="nav-link" data-toggle="dropdown" href="#">
         <img src="{{ asset('storage/photos/'.(auth()->user()->photo?auth()->user()->photo:'default.png'))}}" alt="user-photo"
           style="opacity:.8; width: 25px;margin-top: -6px;" class="border-1 profile-photo img-circle elevation-3">
       </a>
       <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
         <div class="card card-widget widget-user" style="margin-bottom: -0px;">
           ...
           <div class="widget-user-image mb-2">
             ...
             <span style="margin-right: -20px" class="vip_level theme-bg  radius-24">
               <img style="width:35px; padding:0.4px" src="{{ asset('storage/photos/'.auth()->user()->vip_level.'.png')}}" alt="badge" title="{{auth()->user()->vip_level}} member">
             </span>
